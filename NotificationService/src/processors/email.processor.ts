...
import { renderConfirmedBookingEmail } from "../templates/confirmed_booking.handler";
...
export const setupMailerWorker = () => {
    ...
    const emailProcessor = new Worker<NotificationDto>(
        ...
        async (job: Job) => {
            ...
            const emailContent = await renderConfirmedBookingEmail(payload.templateId, payload.params);
